...
public class TestException {
  @ExceptionHandler(value = IllegalArgumentException.class, priority = 0)
  ...
  @ExceptionHandler(value = IllegalArgumentException.class, priority = 1)
  ...
  @ExceptionHandler(value = IllegalArgumentException.class, priority = 2)
